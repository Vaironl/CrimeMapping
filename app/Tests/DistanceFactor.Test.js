...
class Test_DistanceFactor {
    /**
     * @description Tests the function DistanceFactor.calcDistanceBetween()
     *
     * @returns {boolean} - returns true if DistanceFactor.calcDistBetween() is within 1% of the true distance
     *                      between the two points
     */
    static calcDistanceBetween() {
        ...
        let experimental = DistanceFactor.calcDistanceBetween(crime.x, crime.y, point.y, point.y);
